 ...
 */
 ...
 const showLoading = () => {
     if (loadingRequestCount === 0) {
        ...
        //  loadingInstance = ElLoading.service({ text:'拼命加载中。。。',background: 'rgba(255, 255, 255, 0.6)'});
        loadingInstance = ElLoading.service({ text:'拼命加载中。。。',spinner:'',background: 'url(/Test.gif) center center no-repeat'});
